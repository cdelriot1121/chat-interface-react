...
import ArchivedChats from './dialogs/ArchivedChats'
...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <>
            ...
            <DropdownMenu.Portal>
              <DropdownMenu.Content className="bg-white rounded-lg shadow-lg p-2 w-56">
                ...
                <DropdownMenu.Item 
                  ...
                  onSelect={() => setDialogOpen({ ...dialogOpen, preferences: true })}
                >
                ...
                <DropdownMenu.Item 
                  className="px-2 py-1 text-sm cursor-pointer hover:bg-gray-100 rounded flex items-center"
                  onSelect={() => setDialogOpen({ ...dialogOpen, notifications: true })}
                >
                ...
                <DropdownMenu.Item 
                  className="px-2 py-1 text-sm cursor-pointer hover:bg-gray-100 rounded flex items-center"
                  onSelect={() => setDialogOpen({ ...dialogOpen, archivedChats: true })}
                >
      ...
      <Preferences 
        isOpen={dialogOpen.preferences}
        onClose={() => setDialogOpen({ ...dialogOpen, preferences: false })}
      />
      <Notifications 
        isOpen={dialogOpen.notifications}
        onClose={() => setDialogOpen({ ...dialogOpen, notifications: false })}
      />
      <ArchivedChats 
        isOpen={dialogOpen.archivedChats}
        onClose={() => setDialogOpen({ ...dialogOpen, archivedChats: false })}
      />
    </>
  )
}
